...
-- INCLUDES VENDOR ORDERS FIX, SHOP STATUS TOGGLE, AND NOTIFICATIONS
-- ============================================================
-- This script:
...
-- 8. CREATES notifications table for Super Admin to send notifications to vendors
-- 
...
-- ========================================
-- PART 11: DISABLE RLS ON NOTIFICATIONS TABLE (IF EXISTS)
-- ========================================

ALTER TABLE IF EXISTS notifications DISABLE ROW LEVEL SECURITY;

-- ========================================
-- PART 12: CREATE NOTIFICATIONS TABLE FOR VENDOR APP
-- ========================================
-- This section creates the notifications table to store notifications
-- sent from the Super Admin dashboard to vendors
-- ========================================

-- Step 12.1: Create notifications table
...
-- Step 12.2: Create indexes for better query performance
...
-- Step 12.3: Create index for unread notifications
CREATE INDEX IF NOT EXISTS idx_notifications_unread ON notifications(shop_id, is_read) WHERE is_read = false;

-- Step 12.4: Disable RLS (Row Level Security) for notifications table
ALTER TABLE notifications DISABLE ROW LEVEL SECURITY;

-- Step 12.5: Add comments
...
-- Step 12.6: Verify the table was created
SELECT 
  '✅ Step 12: Notifications table created successfully' as status,
  COUNT(*) as total_notifications
FROM notifications;

SELECT '✅ Step 12: Notifications table setup complete!' as status;
...
✅ Created notifications table for Super Admin to send notifications to vendors
...
✅ Notifications table created - Super Admin can send notifications to vendors!
...
8. Super Admin can send notifications by inserting into notifications table
9. Vendors can view notifications in vendor app by clicking the bell icon
...
- Notifications table is ready - Super Admin can insert notifications for vendors
- Notifications are linked to shop_id and/or user_id for proper filtering
- Vendors will see notifications in the vendor app notifications screen
